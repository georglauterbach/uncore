...
const QEMU_KERNEL_BINARY: Option<&str> = option_env!("QEMU_KERNEL_BINARY");

pub fn get_qemu_kernel_binary() -> (&'static str, String)
{
	(
		"QEMU_KERNEL_BINARY",
		QEMU_KERNEL_BINARY
			.expect("Expected environment variable 'QEMU_KERNEL_BINARY' to be set")
			.to_string(),
	)
}
